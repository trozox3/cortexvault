...
import { FileText, Folder, MoreVertical, Plus, Search, UploadCloud } from 'lucide-react';
      ...
      <div className="bg-[#0F172A] border border-[#334155] rounded-xl flex-1 flex flex-col overflow-hidden">
        ...
        <div className="p-4 border-b border-[#334155] flex justify-between items-center bg-[#0F172A]">
          ...
          <div className="flex gap-2">
            <select className="bg-[#1E293B] border border-[#334155] text-white text-sm rounded-md px-3 py-2 outline-none focus:border-cyan-500">
